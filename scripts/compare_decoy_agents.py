...
DECOY_AGENTS: list[AgentSpec] = [
    AgentSpec(Agent360, "gradient", "Agent360 (gradient)"),
...
def main(
    ...
    console.print("\n[bold]Mean Concealing vs learners (BOA, MAP, MiCRO)[/bold]")
    learners = {"BOANeg", "MAPNeg", "MiCRONegotiator"}
    for mode in sorted(by_mode):
        learner_rows = [
            r for r in panel_rows if r["agent_mode"] == mode and r["opponent"] in learners
        ]
        if learner_rows:
