"""FINAL ANL 2026 submission — Agent360 (V4.6 label = restored V4.2 logic).

*** This is the agent that was submitted. ***

Packaged as ``agent360.py`` inside ``submitted_v4.zip`` for upload
(module ``agent360``, class ``Agent360``).

Older variants live under ``drafts/`` (V3, V4.3, V4.5, ablations, etc.).
"""
