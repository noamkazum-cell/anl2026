"""Agent360 — self-contained ANL 2026 submission agent (V3 as ``Agent360``).

This file is copied into ``submitted.zip`` as ``agent360.py`` for upload.
Dev variants live in ``agent360_v3.py`` (``Agent360V3``) and earlier versions.
"""
...
class Agent360(Agent360V2):
    """
    Submission agent: V2.4 concealment + anti-competitor opponent modeling.
